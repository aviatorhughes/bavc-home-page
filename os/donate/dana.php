...
<div id="paypal-interface" style="background: #fff;">
  ...
  <p>
    ...
    <select id="fundName" onchange="fundNameChanged()" style="">
	  ...
	  <option value="ebvh">East Bay Vipassana Hall (EBVH)</option>
      <option value="sbvh">South Bay Vipassana Hall (SBVH)</option>
      <option value="sfvh">SF One-day courses</option>
